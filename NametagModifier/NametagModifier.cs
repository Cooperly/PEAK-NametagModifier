...
[BepInPlugin("club.freewifi.void.NameTagModifier", "NametagModifier", "1.0.0")]
public class NametagModifier : BaseUnityPlugin {
    ...
    private void Awake() {
        ...
        OverrideKey = Config.Bind("Keybinds", "Override Key", KeyCode.T, "Pressing this key will show all nametags of all players for a set amount of time defined in the game settings, regardless of distance or camera angle.");
